(function () {
  ...
  function render(profile, user) {
    ...
    root.innerHTML = [
      ...
      '<a class="btn btn-secondary" href="presskit-artiste.html?download=pdf">Télécharger mon presskit</a>',
      ...
      '<p>Un PDF propre à envoyer aux organisateurs, bars ou lieux. Il reprend votre photo, votre bio, vos styles, vos liens audio, vos infos techniques et le contact via DJ-hub.</p>',
      '<div class="hero-actions">',
      '<a class="btn btn-primary" href="presskit-artiste.html?download=pdf">Télécharger mon presskit PDF</a>',
      '<a class="btn btn-secondary" href="presskit-artiste.html">Prévisualiser / modifier</a>',
      '</div>',
